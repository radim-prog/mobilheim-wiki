# Energeticky úsporný mobilní dům: Jak ušetřit na vytápění
...
**Rekuperace** = systém větrání, který **získává zpět 75-90% tepla** z odváděného vzduchu.
...
### Minimální varianta (úsporná, ale dostupná):
