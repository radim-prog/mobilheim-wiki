# Registrace mobilního domu a zápis do katastru nemovitostí

Registrace mobilního domu v katastru nemovitostí je klíčový právní úkon, který transformuje mobilní objekt na plnohodnotnou nemovitost s vlastnickým titulem zapsaným ve veřejném rejstříku. Tento proces zajišťuje právní jistotu vlastníka, umožňuje získání hypotečního financování a je nezbytným předpokladem pro přidělení **čísla popisného**. Pro přidělení **čísla evidenčního** však zápis do katastru **není nutný** - stačí kolaudace nebo certifikát výrobce. Trvalý pobyt lze hlásit na adrese s **číslem popisným i evidenčním** podle zákona 133/2000 § 10. Zápis do katastru však není možný u všech mobilních domů a vyžaduje splnění přísných stavebněprávních a technických podmínek. Registrace probíhá prostřednictvím Českého úřadu zeměměřického a katastrálního (ČÚZK) a vyžaduje předložení geometrického plánu, dokumentace stavby a dalších zákonem stanovených dokladů.

> **💡 TIP:** Detailní srovnání čísla popisného vs. evidenčního, včetně úspor až 125 000 Kč, najdete v článku [Číslo popisné vs. Číslo evidenční](/wiki/legislativa/cislo-popisne-vs-evidencni.md).
...
[39] Průzkum pojišťoven, 2025
Zdroj: Srovnání pojistných produktů pro mobilní domy, Česká asociace pojišťoven
...
- [Portál ČÚZK – Elektronické podání](https://portal.cuzk.gov.cz)
- [Nahlížení do katastru nemovitostí](https://nahlizenidokn.cuzk.gov.cz)
- [Zákon o katastru nemovitostí – plné znění](https://www.zakonyprolidi.cz/cs/2013-256)
- [Občanský zákoník – plné znění](https://www.zakonyprolidi.cz/cs/2012-89)
- [Stavební zákon – plné znění](https://www.zakonyprolidi.cz/cs/2021-283)
- [Metodika MMR k mobilním domům](/wiki/legislativa/metodiky-mmr/metodika-mobilni-domy-2022.md)
- [Nový stavební zákon a mobilní domy](/wiki/legislativa/stavebni-zakon/novy-zakon-283-2021.md)
