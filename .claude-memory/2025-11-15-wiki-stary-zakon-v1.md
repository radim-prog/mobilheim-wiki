...
Územní plán každé obce vymezoval různé funkční plochy. Plochy pro bydlení byly určené pro stavby rodinných domů, bytových domů a související infrastruktury. Plochy pro rekreaci zahrnovaly chatové oblasti, kempy a rekreační areály. Smíšené plochy umožňovaly kombinaci bydlení, služeb a drobné výroby. Plochy pro zemědělství zahrnovaly ornou půdu, louky, pastviny a lesní pozemky. Průmyslové zóny byly určené pro továrny, sklady a logistická centra.
...
Pokud uvažujete o koupi mobilního domu od předchozího vlastníka který ho umístil v období před červencem 2024 podle starého zákona, je kriticky důležité ověřit právní status objektu ještě PŘED podpisem kupní smlouvy. Bohužel se na trhu běžně objevují nabídky mobilních domů které byly umístěny nelegálně bez územního rozhodnutí nebo které během let ztratily svůj mobilní charakter kvůli přistavbám a trvale připojeným inženýrským sítím.

**Kontrolní seznam před koupí:**

Vyžádejte si od prodávajícího a pečlivě zkontrolujte územní rozhodnutí nebo územní souhlas který mu musel být vydán stavebním úřadem před umístěním mobilního domu. Bez tohoto dokumentu je umístění nelegální i podle starého zákona a nový vlastník zdědí všechny problémy včetně rizika pokuty nebo nařízení odstranění. Ověřte si na stavebním úřadě že rozhodnutí skutečně existuje a že nebylo později zrušeno.

Zkontrolujte zda mobilní dům není pevně spojen se zemí prostřednictvím betonové základové desky s koteními, zda není trvale připojen na inženýrské sítě zabetonovanými přípojkami a zda k němu nebyly přistavěny pevné terasy, verandy nebo jiné konstrukce. Pokud ano, objekt už není výrobkem ale stavbou a měl by mít stavební povolení a kolaudaci. Pokud tyto dokumenty chybí, riskujete že budete muset dodatečně povolit stavbu na vlastní náklady v řádu statisíců korun.

Ověřte si v katastru nemovitostí zda je mobilní dům zapsán jako stavba a zda má přidělené číslo popisné nebo evidenční. Pokud ano, jedná se fakticky o stavbu a musíte zkontrolovat že má řádnou kolaudaci. Pokud mobilní dům v katastru není a nemá číslo, nemůžete v něm získat trvalé bydliště.

Zjistěte si na obecním úřadě zda pozemek podle územního plánu umožňuje umístění mobilního domu - tedy zda jde o plochu pro bydlení nebo rekreaci. Pokud je pozemek určen pouze k zemědělství nebo lesu, umístění je nelegální a hrozí nařízení odstranění.

**Jak vám pomůžeme:**

Nabízíme komplexní právní audit mobilního domu před koupí, kde za vás zkontrolujeme všechny dokumenty, ověříme status na úřadech a vyhodnotíme rizika. Pokud zjistíme problémy, pomůžeme vám je vyřešit - zajistíme dodatečné povolení, vyřídíme chybějící dokumenty nebo vám poradíme zda je lepší od koupě ustoupit. Tím se vyhnete nepříjemnému překvapení kdy po koupi zjistíte že jste zdědili nelegální stavbu a musíte investovat stovky tisíc do jejího dodatečného povolení.
...
Ochrana veřejných zájmů zůstává zachována i nadále, kdy je nutné ověřit soulad stavby s územním plánem a získat stanoviska dotčených orgánů. Certifikát shody výrobku musí být dodán s každým mobilním domem a potvrzuje splnění technických požadavků. Mobilní domy musí splňovat urbanistické a technické požadavky stanovené prováděcími vyhláškami a stavby provedené bez povolení lze za určitých podmínek dodatečně legalizovat.

---

### ✅ Jak vám pomůžeme s přechodem na nový zákon

Pokud máte mobilní dům umístěný podle starého zákona před červencem 2024, nemusíte se ničeho obávat - váš dům je legální podle pravidel platných v době jeho instalace a tuto legalitu vám nikdo nemůže zpětně zpochybnit. Problém ale může nastat ve chvíli kdy budete chtít provést jakékoliv stavební úpravy, rozšíření nebo přístavby. V takovou chvíli už budete muset postupovat podle nového zákona č. 283/2021 Sb. a respektovat všechna jeho ustanovení včetně nových limitů velikosti a požadavků na ohlášení.

My vám pomůžeme s tímto přechodem komplexně. Nejprve posoudíme právní status vašeho stávajícího mobilního domu a ověříme zda máte kompletní dokumentaci včetně územního rozhodnutí a certifikátu shody výrobku. Pokud jakékoliv dokumenty chybí, pomůžeme vám je dodatečně získat nebo prokázat že objekt byl umístěn legálně i bez nich.

Když budete plánovat jakoukoliv stavební úpravu, zjistíme za vás jestli vyžaduje ohlášení nebo povolení podle nového zákona a v případě potřeby zajistíme všechny formality - vypracování projektové dokumentace, vyřízení ohlášení na stavebním úřadě, koordinaci s dotčenými orgány a správci sítí. Vy nemusíte studovat nový zákon ani trávit dny na úřadech, my to vyřídíme za vás.

Zásadně se také postaráme o to aby dodatečné změny neohrozily právní status vašeho domu. Některé úpravy totiž mohou vést k tomu že mobilní dům ztratí status výrobku a stane se klasickou stavbou vyžadující komplexní dodatečné povolení. My víme přesně kde je hranice a poradíme vám jak provést úpravy tak aby zůstaly v rámci zákona a nezvýšily vaše náklady.
...
>
> 16. **výrobky plnící funkci stavby.**
...
>
> a) stavba splňuje požadavky tohoto zákona a jeho prováděcích právních předpisů,
> b) stavba je v souladu s územně plánovací dokumentací,
> c) stavba nebyla provedena v rozporu s rozhodnutím stavebního úřadu,
> d) nebyla porušena práva účastníků řízení.
>
